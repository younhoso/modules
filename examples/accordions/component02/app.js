(function () {
  ...
  new tr.Ratio({
    targets: {
      startEl: '.tr_container', // 컴포넌트 상의 루트(Element)를 시작 선택자로 선언 합니다.
    ...
    additems: 5, // 추가 하고 싶은 항목의 객수를 뜻합니다.(1개 이상의 값을 넣어야만 실행 가능합니다.)
    addClassName: 'more_active', // numbering이라는 클래스 위치에 또다른 클래스를 추가할수 있습니다.
    template: function (idIdx, current, total, addClassName = 'none') {
